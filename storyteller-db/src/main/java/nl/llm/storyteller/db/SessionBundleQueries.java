...
final class SessionBundleQueries {
  static final String DELETE_GRAPH = "DELETE FROM knowledge_graph WHERE session_id = ?";
  static final String DELETE_GRAPH_ALIASES = "DELETE FROM knowledge_entity_alias WHERE session_id = ?";
  static final String DELETE_GRAPH_ENTITIES = "DELETE FROM knowledge_entity WHERE session_id = ?";
  static final String DELETE_GRAPH_FACTS = "DELETE FROM knowledge_fact WHERE session_id = ?";
  static final String DELETE_TURN_PROTAGONISTS = "DELETE FROM turn_protagonist WHERE session_id = ?";
  static final String DELETE_TURN_STATE = "DELETE FROM turn_state WHERE session_id = ?";
